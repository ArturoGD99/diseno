    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
                <a href="#" id="auditoria" class="nav-link" onclick="activar_opcion('auditoria'); Submenu('sub_ficha'); Ajax_Dinamico('auditoria.php','centro','');"><i class="nav-icon fas fa-tasks"></i><p>Auditoría<i class="right fas fa-angle-left"></i></p></a>
            </li>
            <li class="nav-item has-treeview">
                <a href="#" id="recibir" class="nav-link" onclick="activar_opcion('recibir'); Submenu('sub_ficha'); Ajax_Dinamico('recepcion.php','centro','');"><i class=" nav-icon fas fa-tshirt"></i><p>Recepción<i class="right fas fa-angle-left"></i></p></a>
            </li>
            <li class="nav-item has-treeview">
