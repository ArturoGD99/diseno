    ...
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-pencil-ruler"></i>  Modelo</h3>&nbsp;&nbsp;&nbsp;<!--fas fa-tshirt-->
                <h3 class="card-title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item"><a class="nav-link active" href="#modelo" onclick="Validar_Tab(0)" data-toggle="tab">Modelo</a></li>
                        <!--<li class="nav-item"><a class="nav-link" href="#combinaciones" data-toggle="tab">Combinaciones</a></li>-->
                        <li class="nav-item"><a class="nav-link" href="#combinaciones2" onclick="Validar_Tab(0)" data-toggle="tab">Combinaciones</a></li>
                        <li class="nav-item"><a class="nav-link" href="#habil" onclick="Validar_Tab(0)" data-toggle="tab">Habilitaci&oacute;n</a></li>
                        <li class="nav-item"><a class="nav-link" href="#composicion" onclick="Validar_Tab(0)" data-toggle="tab">Composici&oacute;n</a></li>
                        <li class="nav-item"><a class="nav-link" href="#pzas" onclick="Validar_Tab(0)" data-toggle="tab">Piezas</a></li>
                        <li class="nav-item"><a class="nav-link" id="tab_med" href="#medidas" onclick="Validar_Tab(1)" data-toggle="tab">Medidas</a></li>
                        <li class="nav-item"><a class="nav-link" href="#indicaciones" onclick="Validar_Tab(0)" data-toggle="tab">Indicaciones</a></li>
                        <li class="nav-item">
            ...
            <div class="card-body"><input type="hidden" id="id_ficha"><input type="hidden" id="cor" value = "">
                <div class="tab-content p-0" style="border: solid 0px blue">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" id="cmbpatronista" name="ncmbpatronista" tabindex="9">
                                            ...
                                            <optgroup>
                                                ...
                                                <option value="JAQUELIN MENDOZA">JAQUELIN MENDOZA</option>
                    ...
                    <div class="chart tab-pane" id="habil" style="position: relative;">
                        <input type="hidden" id="tvar"><!--Cantidad de variantes-->
                        <input type="hidden" id="tcor"><!--Corrida-->
                        <input type="hidden" id="trango"><!--Rango de id´s para actualizar habilitaciones-->
                        <div class="row">
                    ...
                    <div class="chart tab-pane" id="composicion" style="position: relative;"><br>
                        ...
                        <div id="dv_otro" class="row"><!--style="display: none"-->
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label>Tipo</label>
                            ...
                            <div class="col-md-6">
                                <div id="dv_tbl_otro" class="table-responsive">
                                    <table  id="tbl_otro" class="table table-bordered table-hover" style="display: block; font-size: 15px">
                                        <thead><tr><th>Tipo</th><th>Descripcion</th><th>Composicion</th><th></th></tr></thead>
                                    </table>
                                </div>
                            </div>
                        </div><br>
                            ...
                            <div class="col-md-6">
                                <div id="dv_pzas" class="table-responsive">
                                    <table  id="tbl_pzas" class="table table-bordered table-hover" style="display: none; font-size: 15px">
                                        <thead><tr><th>Nombre</th><th>Cantidad</th><th>Tipo</th><th></th></tr></thead>
                                    </table>
                                </div>
                            </div>
